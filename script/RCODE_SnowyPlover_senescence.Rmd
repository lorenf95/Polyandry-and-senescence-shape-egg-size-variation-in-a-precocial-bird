...
Ceuta_OPEN <- 
  dbConnect(SQLite(), dbname = "data/Ceuta_CLOSED_mdd_v1-1-5.sqlite")
```
***
...
summary(poly_lay_date_linear)
summary(poly_lay_date_quadratic)
...
plot(effect("jul_std_date", poly_lay_date_linear)) # no apparent relationship
```
